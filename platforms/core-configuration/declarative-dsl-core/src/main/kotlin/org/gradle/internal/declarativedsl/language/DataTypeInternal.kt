...
object DataTypeInternal {
    ...
    data class DefaultParameterizedTypeSignature(
        ...
        override fun equals(other: Any?): Boolean { // needed to also work with Java dynamic proxies generated by the Tooling API
            ...
            if (other == null || other !is DataType.ParameterizedTypeSignature) return false
        ...
        data class TypeParameter(override val name: String, override val isOutVariant: Boolean) : DataType.ParameterizedTypeSignature.TypeParameter {
            override fun equals(other: Any?): Boolean { // needed to also work with Java dynamic proxies generated by the Tooling API
                if (this === other) return true
                if (other == null || other !is DataType.ParameterizedTypeSignature.TypeParameter) return false
                return other.name == name && other.isOutVariant == isOutVariant
            }
        }
    ...
    data class DefaultParameterizedTypeInstance(
        ...
        override fun equals(other: Any?): Boolean { // needed to also work with Java dynamic proxies generated by the Tooling API
            if (this === other) return true
            if (other == null || other !is DataType.ParameterizedTypeInstance) return false
            return other.typeSignature == typeSignature &&
    ...
    data class DefaultTypeVariableUsage(
        ...
        override fun equals(other: Any?): Boolean { // needed to also work with Java dynamic proxies generated by the Tooling API
            if (this === other) return true
            if (other == null || other !is DataType.TypeVariableUsage) return false
